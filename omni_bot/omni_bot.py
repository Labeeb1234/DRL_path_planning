...
class OmniBot:
    ...
    def __init__(self, a, L, W, t, initial_pos=(0,0,0)):
        ...
        # bot body outline wrt bot centre
        self.body = np.array([
            [-self.l, -self.w],
            [self.l, -self.w],
            [self.l, self.w],
        ...
        self.init_x, self.init_y, self.init_yaw = initial_pos
        # based on the bot COM (assumed at the geometric centre for now)
        self.pose = np.array([self.init_x, self.init_y, self.init_yaw]).reshape((3,1))
